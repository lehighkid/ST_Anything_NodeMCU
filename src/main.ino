...
//#define PIN_SWITCH_1 D6            //SmartThings Capability "Switch"
//#define PIN_SWITCH_2 D7            //SmartThings Capability "Switch"
...
#define PIN_MOTION_1 D1              //SmartThings Capabilty "Motion Sensor" (HC-SR501 PIR Sensor)
...
#define PIN_TEMPERATUREHUMIDITY D3 //SmartThings Capabilty "Temperature and Humidity Measurement" (DHT11 and DHT22)
//#define PIN_TIMEDRELAY_1 D7        //SmartThings Capability "Relay Switch"
...
void setup()
{
  ...
  //static st::EX_Switch executor11(F("switch11"), PIN_SWITCH_1, LOW, true); //Inverted logic for "Active Low" Relay Board
  //static st::EX_Switch executor12(F("switch12"), PIN_SWITCH_2, LOW, true); //Inverted logic for "Active Low" Relay Board

  // Add support for RF 433 Switches:
  // Set number 1 - 0323
  //static st::EX_RCSwitch executor1(F("switch1"), PIN_RCSWITCH, "000000010001010100110011", "000000010001010100111100", 1, 4, LOW, 189);
  //static st::EX_RCSwitch executor2(F("switch2"), PIN_RCSWITCH, "000000010001010111000011", "000000010001010111001100", 1, 4, LOW, 189);
  //static st::EX_RCSwitch executor3(F("switch3"), PIN_RCSWITCH, "000000010001011100000011", "000000010001011100001100", 1, 4, LOW, 189);
  //static st::EX_RCSwitch executor4(F("switch4"), PIN_RCSWITCH, "000000010001110100000011", "000000010001110100001100", 1, 4, LOW, 189);
  //static st::EX_RCSwitch executor5(F("switch5"), PIN_RCSWITCH, "000000010011010100000011", "000000010011010100001100", 1, 4, LOW, 189);
  // Set number 2 - 0319
  //static st::EX_RCSwitch executor6(F("switch6"), PIN_RCSWITCH, "000001010001010100110011", "000001010001010100111100", 1, 4, LOW, 189);
  //static st::EX_RCSwitch executor7(F("switch7"), PIN_RCSWITCH, "000001010001010111000011", "000001010001010111001100", 1, 4, LOW, 189);
  //static st::EX_RCSwitch executor8(F("switch8"), PIN_RCSWITCH, "000001010001011100000011", "000001010001011100001100", 1, 4, LOW, 189);
  //static st::EX_RCSwitch executor9(F("switch9"), PIN_RCSWITCH, "000001010001110100000011", "000001010001110100001100", 1, 4, LOW, 189);
  //static st::EX_RCSwitch executor10(F("switch10"), PIN_RCSWITCH, "000001010011010100000011", "000001010011010100001100", 1, 4, LOW, 189);
